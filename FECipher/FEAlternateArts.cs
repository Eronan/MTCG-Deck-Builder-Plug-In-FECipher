...
namespace FECipher
{
    ...
    {
        public FEAlternateArts(string id, string setCode, string imageLocation, string lackeyCCGId, string lackeyCCGName, string cipherVitId, string imageDownloadURL)
        {
            Id = id;
            SetCode = setCode;
        ...
        [JsonPropertyOrder(5)]
        public string CipherVitId { get; set; }
